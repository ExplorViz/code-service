package net.explorviz.code.kafka.conversion;

import static net.explorviz.code.kafka.conversion.DefaultAttributeValues.DEFAULT_APP_INSTANCE_ID;
import static net.explorviz.code.kafka.conversion.DefaultAttributeValues.DEFAULT_APP_LANG;
import static net.explorviz.code.kafka.conversion.DefaultAttributeValues.DEFAULT_APP_NAME;
import static net.explorviz.code.kafka.conversion.DefaultAttributeValues.DEFAULT_FQN;
import static net.explorviz.code.kafka.conversion.DefaultAttributeValues.DEFAULT_HOST_IP;
...
public class AttributesReader {
  ...
  public void appendToStructure(final SpanStructure.Builder builder) {
    builder.setLandscapeToken(this.getLandscapeToken()).setHostname(this.getHostName())
        .setHostIpAddress(this.getHostIpAddress()).setAppInstanceId(this.getApplicationInstanceId())
        .setAppName(this.getApplicationName()).setAppLanguage(this.getApplicationLanguage())
